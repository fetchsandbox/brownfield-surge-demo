...
**Use `AskUserQuestion` — NEVER a prose numbered list with "Choose a
number (1-5)..." text prompt.** The picker IS the option surface.
...
```
    ...
    AskUserQuestion(questions=[{
      header: "Elicit",
      question: "Pick a critique technique to apply",
      options: [
        {label: "[Method Name 1]", description: "<one-line from CSV description>"},
        {label: "[Method Name 2]", description: "<one-line from CSV description>"},
        {label: "[Method Name 3]", description: "<one-line from CSV description>"},
        {label: "[Method Name 4]", description: "<one-line from CSV description>"},
        {label: "[Method Name 5]", description: "<one-line from CSV description>"},
        {label: "Reshuffle the list", description: "Show 5 new methods from a different category"},
        {label: "Proceed / no further actions", description: "End elicitation and continue"},
      ],
    }])

(AskUserQuestion caps at 4 options + Other. If you need to show 5
methods + reshuffle + proceed = 7 entries, group as "Top 5 + actions":
ask twice — first picker is the 5 methods, second picker handles
"reshuffle vs proceed vs list all" only after the user picks one.)
